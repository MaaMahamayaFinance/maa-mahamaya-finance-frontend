...
const InternCertificate = () => {
    ...
    const certificateType = "INTERNSHIP";
    ...
    <>
        ...
        <div className="w-full min-h-screen flex flex-col items-center justify-center bg-gray-100 p-2 sm:p-4 md:p-6 relative">
            ...
            className="fixed top-4 right-4 sm:absolute sm:top-4 sm:right-4 bg-red-600 hover:bg-red-700 text-white font-semibold px-3 py-2 sm:px-4 sm:py-2 text-xs sm:text-sm rounded-md shadow-md transition z-20"
            >
            Download PDF
            </button>
