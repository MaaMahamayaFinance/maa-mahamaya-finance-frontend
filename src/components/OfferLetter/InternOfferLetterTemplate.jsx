...
const InternOfferLetterTemplate = ({
    letterDate,
    name,
    pincode,
    joiningDate,
    ...
    return (
        ...
        <ol className="list-decimal list-inside space-y-5 text-sm leading-relaxed text-gray-800">
            ...
            {ctc && parseFloat(ctc) > 0 ? (
                ...
                <span className="font-medium">{ctc}</span>. Salary will be remitted on the
                10th of each month. No PF or ESI will be deducted. Insurance & health
                policies are not covered by the company.
                </>
            ) : (
                <>
                You are hired as an unpaid intern in our company. Therefore, no
                compensation will be provided during the internship period. You will be
                offered a Pre-Placement Offer (PPO) based on your performance during the
                internship.
                </>
            )}
            </li>
...
export default InternOfferLetterTemplate;
