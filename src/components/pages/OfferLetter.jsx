...
import OfferLetterTemplate from "../OfferLetter/OfferLetterTemplate.jsx";
import { fetchMyEmployeeOfferLetter } from "../api/employeeAPI.js";
...
const OfferLetter = () => {
  ...
  useEffect(() => {
    const getOfferLetter = async () => {
      try {
        const data = await fetchMyEmployeeOfferLetter(token);
        setOfferData(data);
      } catch (error) {
